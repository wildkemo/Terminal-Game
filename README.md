NOTE : To run the game correctly change the Launch size to columns:157 and Rows: 40 in the Terminal window setting in MICROSOFT VIRTUAL STUDIO (The purpule one) and not VScode.
